...
const socialLinks = [
  {title: "Git", url: "https://github.com/zkHubHQ", icon: GithubLogo},
  {
    title: "Discord",
    url: "https://discord.com/invite/zkHubHQ",
    icon: DiscordLogo,
  },
  {title: "Twitter", url: "https://twitter.com/zkHubHQ/", icon: TwitterLogo},
  // {title: "Medium", url: "https://zkHub.medium.com/", icon: MediumLogo},
  {
    title: "LinkedIn",
    url: "https://www.linkedin.com/company/zkHubHQ/",
    icon: LinkedInLogo,
  },
];
